    ...
    var $ = (function (n, e, k, h, p, m, l, b, d, g, f, c) {
            ...
            k.push.apply(
                ...
                a
                    ? a.nodeType || a == n
                        ...
                        : "" + a === a
                        ? /</.test(a)
                            ? (((b = e.createElement(d || "q")).innerHTML = a), b.children)
                            : ((d && c(d)[0]) || e).querySelectorAll(a)
                        : /f/.test(typeof a)
                        ? /c/.test(e.readyState)
                            ? a()
                            : c(e).on("DOMContentLoaded", a)
                        : a
                    : k
            );
        };
        c.i[(f = "prototype")] = (c.extend = function (a) {
            ...
            off: function (a, c) {
                ...
                f = "remove" + m;
                this.map(function (e) {
                    if ((b = (g = h[a[0] + e.b$]) && g.length)) for (; (d = g[--b]); ) (c && c != d[0]) || (a[1] && a[1] != d[1]) || (e[f](a[0], d[0]), g.splice(b, 1));
                    else !a[1] && e[f](a[0], c);
                });
                return this;
            },
    ...
    var create = function (tagName, props) {
        ...
        Tree = function (s, options) {
            var _this = this,
                ...
                tree = (_this.tree = container.appendChild(
                    create("ul", {
                        className: "vtree",
                    })
                ));
